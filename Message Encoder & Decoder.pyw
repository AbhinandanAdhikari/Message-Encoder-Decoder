...
Label(root, text ='This Project is created by Abhinandan Adhikari', font = ('arial', 16, 'bold'),bd=16, anchor="w").pack(side =BOTTOM)
...
lblkey = Label(f1, font=('arial', 16, 'bold'),
               text="ENTER YOUR KEY", bd=16, anchor="w")
...
lblmode = Label(f1, font=('arial', 16, 'bold'),
                text="MODE(e for encode, d for decode)",
                bd=16, anchor="w")
